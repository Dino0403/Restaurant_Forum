  ...
  <div class="container py-5">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <!-- 最新評論 NewestComments-->
        <h3>最新評論</h3>
        <NewestRestaurantComment v-bind:comments="comments" />
      </div>
    </div>
  </div>
</template>
...
import NewestRestaurantComment from "../components/NewestRestaurantComment.vue";
...
export default {
  components: {
    ...
    NewestRestaurantComment: NewestRestaurantComment,
  },
  data() {
    return {
      restaurants: [],
  ...
  methods: {
    fetchFeeds() {
      ...
      this.comments = comments.filter(
        (comments) => comments.Restaurant && comments.text
      );
    },
  },
  created() {
